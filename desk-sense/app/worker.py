...
def main():
    ...
    ap.add_argument("--fake-policy", choices=("random", "first"), default="random")
    ...
    model = FakeModel(args.fake_delay, args.fake_policy) if args.fake else RealModel(args.bundle, args.threads, args.max_len)
    serve(model, out)
